...
},{"process":"../node_modules/process/browser.js"}],"../src/pixel-flow.js":[function(require,module,exports) {
/*
...
var _pixelFlow = _interopRequireDefault(require("./pixel-flow.js"));
...
_jquery.default.fn[pluginName] = function (options) {
  var $cvs;
  this.each(function () {
    var r = _jquery.default.data(this, 'plugin_' + pluginName);

    if (!r) {
      r = new _pixelFlow.default(this, options);

      _jquery.default.data(r.canvas, 'plugin_' + pluginName, r);
    } else {
    ...
    if (typeof $cvs === 'undefined') $cvs = (0, _jquery.default)(r.canvas);else $cvs.add(r.canvas);
  });
  return $cvs;
};
},{"jquery":"../node_modules/jquery/dist/jquery.js","./pixel-flow.js":"../src/pixel-flow.js"}],"scripts/index-old.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)(document).ready(function () {
  var $imgs = (0, _jquery.default)('.img-wrapper img');
  Promise.all($imgs.map(function (_, img) {
    ...
    (0, _jquery.default)('.btn-wrapper button').on('click', function (ev) {
      ...
      $btn.closest('.img-wrapper').find('canvas').PixelFlow(func, _jquery.default.extend({
        offsetX: offsetX
      }, funcOpts[id][func] || {}));
    });
  });
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","../../src/jquery":"../src/jquery.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/index-old.js"], null)
//# sourceMappingURL=/pixel-flow/index-old.b415842e.map